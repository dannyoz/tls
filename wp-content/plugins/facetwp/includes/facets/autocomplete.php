...
class FacetWP_Facet_Autocomplete
{
    ...
    function render( $params ) {
        ...
        $output .= '<input type="text" class="facetwp-autocomplete" value="' . $value . '" placeholder="Start typing..." />';
        $output .= '<input type="button" class="facetwp-autocomplete-update" value="Update" />';
        return $output;
    }
