    ...
    <section id="latest-edition" ng-controller="latesteditions" ng-cloak>
        ...
        <div class="container relative" ng-if="ready" ng-swipe-right="chooseEdition('prev',prev)" ng-swipe-left="chooseEdition('next',next)">
            ...
            <div class="article-links" ng-if="size == 'desktop'">
                <div class="inner">
                    <a ng-href="{{::nextEdition.url}}" ng-if="nextEdition.title != null" class="article-nav next-article">
                        <div class="icon icon-right-arrow"><span ng-bind-html="nextEdition.title"></span></div>
                    </a>
                    <a ng-href="{{::previousEdition.url}}" ng-if="previousEdition.title != null" class="article-nav prev-article">
                        <div class="icon icon-left-arrow"><span ng-bind-html="previousEdition.title"></span></div>
                    </a>
                </div>
            </div>
            ...
            <div class="edition-current">
                ...
                <h1 ng-if="size == 'desktop'" ng-bind-html="latestEdition.title"></h1>
                    ...
                    <div class="editions-top-right fadeIn">
                        <div class="grid-row">
                            ...
                            <div class="public-col">
                                ...
                                <div class="edition-item" ng-repeat="public in publicObj.articles">
                                    <div class="padded">
                                        ...
                                        <p class="title-small" ng-bind-html="public.author"></p>
                            ...
                            <div class="regular-col">
                                <h2 ng-bind-html="regularsObj.title"></h2>
                                <div class="edition-item" ng-repeat="regular in regularsObj.articles">
                                    <div class="padded" ng-class="{ 'private' : regular.taxonomy_article_visibility[0].slug == 'private'}">
                                        <h3 class="futura" ng-show="regular.type == 'then_and_now'" >
                                            <a href="javascript:void(0)" >Then And Now</a>
                                            <i class="icon icon-key-after" ng-if="regular.taxonomy_article_visibility[0].slug == 'private'"></i>
                                        </h3>
                                        <h3 class="futura" ng-hide="regular.type == 'then_and_now'">
                                            <a href="{{regular.section.link}}" ng-bind-html="regular.section.name"></a>
                                            <i class="icon icon-key-after" ng-if="regular.taxonomy_article_visibility[0].slug == 'private'"></i>
                                        </h3>
                                        <p class="title-small" ng-bind-html="regular.author"></p>
                                        <h4><a href="{{regular.url}}" ng-bind-html="regular.title"></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div ng-if="ready" class="editions-bottom fadeIn">
            ...
            <div class="container relative">
                <div class="title-icon icon">
                    ...
                    <h2 ng-bind-html="subscribersObj.title"></h2>
                </div>
                ...
                <div class="grid-row" ng-if="size == 'desktop'">
                    ...
                    <div  class="grid-4" ng-repeat="column in col3">
                        ...
                        <div class="card-flat" ng-repeat="card in column">
                            <h3 class="futura">
                                <a ng-href="{{card.section.link}}" ng-bind-html="card.section.name"></a>
                            </h3>
                            <div class="edition-item" ng-repeat="post in card.posts">
                                <div class="padded">
                                    <p class="title-small" ng-bind-html="post.author"></p>
                                    <h4><a ng-href="{{::post.url}}" ng-bind-html="post.title"></a></h4>
                                </div>
                            </div>
