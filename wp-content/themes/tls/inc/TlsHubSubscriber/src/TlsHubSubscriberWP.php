...
//        'error_messages_switch' => 1
    ...
    {
        add_menu_page('TLS Hub Subscriber',
            // Text displayed in the browser title bar
                                ...
                                <div class="inside">
                                    ...
                                    <table class="form-table">
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td>
                                                <p class="subscription_status"><?php echo (isset($this->current_options['subscription_status'])) ? $this->current_options['subscription_status'] : '';
                                                    ?></p>
                                            </td>
                                        </tr>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td>
                                                <textarea class="widefat"
                                                          ...
                                                          ?>[log_messages]"
                                                          id="<?php echo self::$option_name;
                                                          ?>[log_messages]" cols="30"
                                                          rows="10"><?php echo (isset($this->current_options['log_messages'])) ? $this->current_options['log_messages'] : '';
                                                    ?></textarea>
                                            </td>
                                        </tr>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td>
                                                <textarea class="widefat"
                                                          ...
                                                          ?>[error_messages]"
                                                          cols="30"
                                                          rows="10"><?php echo (isset($this->current_options['error_messages'])) ? $this->current_options['error_messages'] : '';
                                                    ?></textarea>
                                            </td>
                                        </tr>
<!--                                        <tr valign="top">-->
