...
class TlsHubSubscriberWP
{
     ...
     */
    protected $data = array( 'subscription_id' => '', 'topic_url' => '', 'hub_url' => '', 'log_messages' => '', 'error_messages' => '', 'subscription_status' => 'Unsubscribed' );
    ...
    {
        add_menu_page( 'TLS Hub Subscriber',                                    // Text displayed in the browser title bar
                            ...
                            <div class="postbox">
                                <div class="inside">
                                    ...
                                    <table class="form-table">
                                        ...
                                        <tr valign="top">
                                            <th scope="row">Topic URL:</th>
                                            <td>
                                                <input id="topic_url" class="widefat" type="text"
                                                       name="<?php echo self::$option_name?>[topic_url]"
                                                       value="<?php echo ( isset( $this->current_options[ 'topic_url' ] ) ) ? $this->current_options[ 'topic_url' ] : ''; ?>"/>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td>
                                                <input id="hub_url" class="widefat" type="text"
                                                       name="<?php echo self::$option_name?>[hub_url]"
                                                       value="<?php echo ( isset( $this->current_options[ 'hub_url' ] ) ) ? $this->current_options[ 'hub_url' ] : ''; ?>"/>
                                        ...
                                        <tr valign="top">
                                            <th scope="row">Log Messages:
                                                <p class="description">If you want to clear all Log messages select all
                                                    the messages and delete them before saving changes</p>
                                            </th>
                                            <td>
                                                <textarea class="widefat"
                                                          name="<?php echo self::$option_name; ?>[log_messages]"
                                                          id="<?php echo self::$option_name; ?>[log_messages]" cols="30"
                                                          rows="10"><?php echo ( isset( $this->current_options[ 'log_messages' ] ) ) ? $this->current_options[ 'log_messages' ] : ''; ?></textarea>
                                            </td>
                                        </tr>

                                        <tr valign="top">
                                            <th scope="row">Error Messages:
                                                <p class="description">If you want to clear all Error messages select
                                                    all the messages and delete them before saving changes</p>
                                            </th>
                                            <td>
                                                <textarea class="widefat"
                                                          name="<?php echo self::$option_name; ?>[error_messages]"
                                                          id="<?php echo self::$option_name; ?>[error_messages]"
                                                          cols="30"
                                                          rows="10"><?php echo ( isset( $this->current_options[ 'error_messages' ] ) ) ? $this->current_options[ 'error_messages' ] : ''; ?></textarea>
                                            </td>
                                        </tr>
                                    ...
                                    <p class="submit">
                                        ...
                                        <input class="button-secondary left tls_hub_action subscribe" type="button"
                                               name="tls_hub_action" value="Subscribe"/>
                                    </p>
    ...
    public function hub_action_javascript()
    {
        ...
        wp_localize_script( 'tls-hub-action-js', 'tls_hub_action', array( 'ajax_admin' => admin_url( 'admin-ajax.php', 'relative' ) ) );
