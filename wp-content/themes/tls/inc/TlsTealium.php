...
class TlsTealium {
    ...
    public function tls_tealium_head()
    {
        ...
        if (is_front_page()) { // Front Page (Home Page)
            ...
            $tealium_data = $this->tealium_data('search results', 'search', 'search', 'public' , array(
            ...
            $tealium_data = $this->tealium_data('', 'errors', 'errors', 'public', array(
            ...
            } else if (strtolower($page->post_title) == 'terms & conditions' || strtolower($page->post_title) == 'terms and conditions') { // If the current page is Terms & Conditions
